...
extension colors on ColorScheme {
  ...
  static const Color secondary = Color(0xff009443);
  ...
  static const Color grad1Color = Color(0xffF58B1B);
  static const Color grad2Color = Color(0xffF58B1B);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffF58B1B);
